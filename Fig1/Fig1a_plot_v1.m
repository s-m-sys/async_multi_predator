...
for t = 1:numel(T)
    ...
    file_dat = load(fullfile('Fig1_data/Fig1a_main', file_name), 'ascii');
...
clust_centroid = clust_centroid./dia_prey;
pred_traj = pred_traj./dia_prey;
...
saveas(gcf, 'Fig1a_main.eps', 'epsc')