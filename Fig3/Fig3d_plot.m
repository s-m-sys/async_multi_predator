...
for i = 1:numel(chi)
    ...
    dat = load(fullfile('Fig3_data/Fig3d_data',filename), '-ascii');
...
ylim([0, 1.8])
xlim([0 200])
saveas(gcf, 'Fig3d_main.eps', 'epsc')
close all;

%% Plot Fig3d inset
dat = load(fullfile('Fig3_data/Fig3d_data', 'nclusters_relang_100.txt'), '-ascii');
...
saveas(gcf, 'Fig3d_inset.eps', 'epsc')