...
clust_speed = load('Fig5_cluster_speed.txt', '-ascii');

loc_order = load('Fig5_locOP.txt', '-ascii');
...
saveas(gcf, 'Fig5.eps', 'epsc');

close all;

%% Plot insets
T = [2.45, 22.05, 37.97, 46.54, 56.34, 68.59, 83.28]';
npred = 2;
...
for t = 1:numel(T)
    ...
    outfile = sprintf('Fig5_inset_%.2f.eps', T(t));
